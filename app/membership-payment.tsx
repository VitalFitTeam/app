...
export default function MembershipPaymentScreen() {
    ...
    const params = useLocalSearchParams<{
        ...
        title?: string;
        branchId: string;
        // New params for deferred invoice creation
    ...
    const handlePay = async () => {
        ...
        const nextParams = {
            ...
            // Pass deferred data
            invoiceItemsJson: params.invoiceItemsJson,
    ...
    const processDirectPayment = async (methodId: string) => {
        ...
        try {
            ...
            // Si no hay factura creada, crearla ahora
            if (!finalInvoiceId && params.invoiceItemsJson) {
                        ...
                        {methods.map((method) => {
                            ...
                            return (
                                <TouchableOpacity
                                    ...
                                    className={`flex-row items-center p-4 mb-3 rounded-xl border ${isSelected
