	...
	return (
		<ThemedView style={styles.container}>
			<View style={styles.formContainer}>
				<Logo />
				<ThemedText type="title" style={styles.title}>{titles[step - 1]}</ThemedText>
				...
				{step === 1 && (
					<>
						<StyledTextInput label="Correo electrónico" placeholder="tucorreo@email.com" keyboardType="email-address" />
				...
				{step === 2 && (
					<>
						...
						<SecondaryButton title="Cancelar" onPress={() => setStep(1)} style={{marginTop: 12}}/>
					</>
				)}
...
const styles = StyleSheet.create({
	...
	formContainer: { width: '100%', maxWidth: 384, paddingHorizontal: 24, alignItems: 'center', gap: 16 },
